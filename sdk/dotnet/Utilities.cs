...
namespace Iwahbe.Resend
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/iwahbe/pulumi-resend";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Iwahbe.Resend.version.txt");
    ...
    internal sealed class ResendResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ResendResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
